...
# Compile Simulator with your 1S Simulator and Cache. Change my_p1s_sim.o to inst_p1s_sim.o if using ours
simulator: cache.c inst_p1s_sim.o
	$(CXX) $(CXXFLAGS) $^ -no-pie $(LINKFLAGS) -o $@
